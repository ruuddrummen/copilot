---
name: refine
description: Interview the user relentlessly about an idea, plan or design until reaching shared understanding, resolving each branch of the decision tree. Use when user wants to stress-test a plan or refine an idea.
---
